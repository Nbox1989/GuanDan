...
public class ImageViewQuit extends ImageView{
	
	private static final int srcLeft=225;
	
	private static final int srcTop=355;
	...
	public ImageViewQuit(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
